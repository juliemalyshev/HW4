...
int main(int argc, char *argv[]){
  ...
  //SDL_Window* window = SDL_CreateWindow(window_title, 10, 10, 800, 600, SDL_WINDOW_OPENGL);

  //The above window cannot be resized which makes some code slightly easier.
  //Below show how to make a full screen window or allow resizing
  //SDL_Window* window = SDL_CreateWindow(window_title, 0, 0, 800, 600, SDL_WINDOW_FULLSCREEN|SDL_WINDOW_OPENGL);
  SDL_Window* window = SDL_CreateWindow(window_title, 100, 100, 800, 600, SDL_WINDOW_RESIZABLE|SDL_WINDOW_OPENGL);
