...
int main(int argc, char *argv[]){
  ...
  printf("\nCompiled against SDL version %d.%d.%d ...\n", compiled.major, compiled.minor, compiled.patch);
	...
	SDL_Window* window = SDL_CreateWindow("My OpenGL Program", 100, 100, 400, 300, SDL_WINDOW_RESIZABLE|SDL_WINDOW_OPENGL);
	...
	GLfloat vertices[] = { //We should read this from a files... for now lets hardcode it
     0.0f,  0.8f, 1.0f, 0.8f, 0.9f, // Vertex 1: postion = (0,.5) color = Red
     0.8f, -0.8f, 1.0f, 0.2f, 0.4f, // Vertex 2: postion = (0,-.5) color = Green
    -0.8f, -0.8f, 1.0f, 0.5f, 0.9f  // Vertex 3: postion = (-.5,-.5) color = Blue
    };
