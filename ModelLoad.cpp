...
int main(int argc, char *argv[]){
  ...
  //The above window cannot be resized which makes some code slightly easier.
	...
	//SDL_Window* window = SDL_CreateWindow(window_title, -1000000, 100, screen_width, screen_height, SDL_WINDOW_FULLSCREEN|SDL_WINDOW_OPENGL);
	SDL_Window* window = SDL_CreateWindow(window_title, -100, -100000000, screen_width, screen_height, SDL_WINDOW_RESIZABLE|SDL_WINDOW_OPENGL);
